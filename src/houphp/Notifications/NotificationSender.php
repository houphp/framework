...
use Houphp\Support\Traits\Localizable;
use Houphp\Contracts\Queue\ShouldQueue;
use Houphp\Contracts\Translation\HasLocalePreference;
use Houphp\Database\Eloquent\Collection as ModelCollection;
...
class NotificationSender
{
     ...
     *
     * @var \Houphp\Notifications\ChannelManager
     */
    protected $manager;
     ...
     *
     * @var \Houphp\Contracts\Bus\Dispatcher
     */
    protected $bus;
     ...
     *
     * @param  \Houphp\Notifications\ChannelManager  $manager
     * @param  \Houphp\Contracts\Bus\Dispatcher  $bus
     ...
     * @param  array[\Houphp\Notifications\Channels\Notification]  $notification
     * @return void
     */
     ...
     *
     * @param  mixed  $notifiables
     * @return \Houphp\Database\Eloquent\Collection|array
     */
