...
namespace Houphp\Notifications\Channels;

use Houphp\Support\Arr;
use Houphp\Support\Str;
use Houphp\Mail\Markdown;
use Houphp\Contracts\Mail\Mailer;
use Houphp\Contracts\Mail\Mailable;
use Houphp\Notifications\Notification;
...
class MailChannel
{
     ...
     * @param  mixed  $notifiable
     * @param  \Houphp\Notifications\Notification  $notification
     * @param  \Houphp\Notifications\Messages\MailMessage  $message
     * @return \Closure
     */
     ...
     *
     * @param  \Houphp\Mail\Message  $mailMessage
     * @param  mixed  $notifiable
     * @param  \Houphp\Notifications\Notification  $notification
     * @param  \Houphp\Notifications\Messages\MailMessage  $message
     * @return void
