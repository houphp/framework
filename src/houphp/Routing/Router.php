...
use Houphp\Contracts\Routing\BindingRegistrar;
use Psr\Http\Message\ResponseInterface as PsrResponseInterface;
use Houphp\Contracts\Routing\Registrar as RegistrarContract;
use Symfony\Bridge\PsrHttpMessage\Factory\HttpFoundationFactory;
use Symfony\Component\HttpFoundation\Response as SymfonyResponse;

/**
 * @mixin \Houphp\Routing\RouteRegistrar
 */
class Router implements RegistrarContract, BindingRegistrar
{
     ...
     *
     * @var \Houphp\Routing\RouteCollection
     */
    protected $routes;
    ...
    {
        return $this->any($uri, '\Houphp\Routing\RedirectController')
    ...
    {
        return $this->match(['GET', 'HEAD'], $uri, '\Houphp\Routing\ViewController')
                ->defaults('view', $view)
                ->defaults('data', $data);
    }
     ...
     *
     * @param  string  $name
     * @return \Houphp\Http\Response|\Houphp\Http\JsonResponse
     */
     ...
     *
     * @param  \Houphp\Support\Collection  $middlewares
     * @return array
     */
     ...
     * Get the currently dispatched route instance.
     *
     * @return \Houphp\Routing\Route|null
     */
     ...
     *
     * @return \Houphp\Routing\RouteCollection
     */
     ...
     *
     * @param  \Houphp\Routing\RouteCollection  $routes
     * @return void
     */
