...
use Houphp\Foundation\Testing\Constraints\HasInDatabase;
use PHPUnit\Framework\Constraint\LogicalNot as ReverseConstraint;
use Houphp\Foundation\Testing\Constraints\SoftDeletedInDatabase;
...
trait InteractsWithDatabase
{
     ...
     *
     * @param  string|\Houphp\Database\Eloquent\Model  $table
     * @param  array  $data
     * @param  string|null  $connection
     * @return $this
     */
