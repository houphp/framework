...
namespace Houphp\Foundation\Testing;

use Closure;
use Houphp\Support\Arr;
use Houphp\Support\Str;
use Houphp\Support\Carbon;
use Houphp\Contracts\View\View;
use Houphp\Database\Eloquent\Model;
use Houphp\Support\Traits\Macroable;
use Houphp\Foundation\Testing\Assert as PHPUnit;
use Symfony\Component\HttpFoundation\StreamedResponse;
use Houphp\Foundation\Testing\Constraints\SeeInOrder;

/**
 * @mixin \Houphp\Http\Response
 */
class TestResponse
{
    use Macroable {
