...
use Houphp\Contracts\Queue\Factory as FactoryContract;
use Houphp\Contracts\Queue\Monitor as MonitorContract;

/**
 * @mixin \Houphp\Contracts\Queue\Queue
 */
class QueueManager implements FactoryContract, MonitorContract
{
     ...
     *
     * @param  string  $driver
     * @return \Houphp\Queue\Connectors\ConnectorInterface
     *
