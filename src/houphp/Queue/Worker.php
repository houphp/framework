...
use Houphp\Database\DetectsLostConnections;
use Houphp\Contracts\Debug\ExceptionHandler;
use Symfony\Component\Debug\Exception\FatalThrowableError;
use Houphp\Contracts\Cache\Repository as CacheContract;
...
class Worker
{
     ...
     *
     * @var \Houphp\Contracts\Cache\Repository
     */
    protected $cache;
     ...
     *
     * @var \Houphp\Contracts\Debug\ExceptionHandler
     */
     ...
     *
     * @param  \Houphp\Queue\QueueManager  $manager
     * @param  \Houphp\Contracts\Events\Dispatcher  $events
     * @param  \Houphp\Contracts\Debug\ExceptionHandler  $exceptions
     * @return void
     */
     ...
     * @param  string  $queue
     * @param  \Houphp\Queue\WorkerOptions  $options
     * @return void
     */
     ...
     *
     * @param  \Houphp\Contracts\Queue\Job|null  $job
     * @param  \Houphp\Queue\WorkerOptions  $options
     * @return void
     */
     ...
     *
     * @param  \Houphp\Contracts\Queue\Queue  $connection
     * @param  string  $queue
     ...
     *
     * @param  \Houphp\Contracts\Queue\Job  $job
     * @param  string  $connectionName
     * @param  \Houphp\Queue\WorkerOptions  $options
     * @return void
     */
     ...
     *
     * @param  \Houphp\Contracts\Cache\Repository  $cache
     * @return void
     */
     ...
     *
     * @return \Houphp\Queue\QueueManager
     */
