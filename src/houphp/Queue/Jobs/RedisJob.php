...
namespace Houphp\Queue\Jobs;

use Houphp\Queue\RedisQueue;
use Houphp\Container\Container;
use Houphp\Contracts\Queue\Job as JobContract;
...
class RedisJob extends Job implements JobContract
{
     ...
     * @param  \Houphp\Queue\RedisQueue  $redis
     * @param  string  $job
     ...
     *
     * @return \Houphp\Queue\RedisQueue
     */
