...
use Houphp\Pipeline\Pipeline;
use Houphp\Contracts\Queue\Queue;
use Houphp\Contracts\Queue\ShouldQueue;
use Houphp\Contracts\Container\Container;
use Houphp\Contracts\Bus\QueueingDispatcher;
...
class Dispatcher implements QueueingDispatcher
{
     ...
     *
     * @param  \Houphp\Contracts\Queue\Queue  $queue
     * @param  mixed  $command
     * @return mixed
     */
