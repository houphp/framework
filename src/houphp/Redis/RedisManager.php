...
namespace Houphp\Redis;

use InvalidArgumentException;
use Houphp\Contracts\Redis\Factory;
use Houphp\Redis\Connections\Connection;
use Houphp\Support\ConfigurationUrlParser;

/**
 * @mixin \Houphp\Redis\Connections\Connection
 */
class RedisManager implements Factory
{
     ...
     *
     * @param  \Houphp\Redis\Connections\Connection  $connection
     * @param  string  $name
     * @return \Houphp\Redis\Connections\Connection
     */
     ...
     *
     * @return \Houphp\Redis\Connectors\PhpRedisConnector|\Houphp\Redis\Connectors\PredisConnector
     */
