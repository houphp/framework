...
namespace Houphp\Redis\Limiters;

use Houphp\Support\InteractsWithTime;
use Houphp\Contracts\Redis\LimiterTimeoutException;
...
class ConcurrencyLimiterBuilder
{
     ...
     *
     * @var \Houphp\Redis\Connections\Connection
     */
    public $connection;
     ...
     * @return mixed
     *
     * @throws \Houphp\Contracts\Redis\LimiterTimeoutException
     */
