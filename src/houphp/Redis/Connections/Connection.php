...
use Houphp\Redis\Events\CommandExecuted;
use Houphp\Redis\Limiters\DurationLimiterBuilder;
use Houphp\Redis\Limiters\ConcurrencyLimiterBuilder;
...
abstract class Connection
{
     ...
     *
     * @param  string  $name
     * @return \Houphp\Redis\Limiters\ConcurrencyLimiterBuilder
     */
     ...
     *
     * @param  string  $name
     * @return \Houphp\Redis\Limiters\DurationLimiterBuilder
     */
