...
namespace Houphp\Validation;

use RuntimeException;
use BadMethodCallException;
use Houphp\Support\Arr;
use Houphp\Support\Str;
use Houphp\Support\Fluent;
use Houphp\Support\MessageBag;
use Houphp\Contracts\Container\Container;
use Houphp\Contracts\Translation\Translator;
use Houphp\Contracts\Validation\ImplicitRule;
use Symfony\Component\HttpFoundation\File\UploadedFile;
use Houphp\Contracts\Validation\Rule as RuleContract;
use Houphp\Contracts\Validation\Validator as ValidatorContract;
...
class Validator implements ValidatorContract
{
     ...
     *
     * @var \Houphp\Contracts\Translation\Translator
     */
     ...
     *
     * @var \Houphp\Validation\PresenceVerifierInterface
     */
     ...
     *
     * @param  \Houphp\Contracts\Translation\Translator  $translator
     * @param  array  $data
     * @param  array  $rules
     ...
     * @param  string  $attribute
     * @param  mixed  $value
     * @param  \Houphp\Contracts\Validation\Rule  $rule
     * @return void
     */
     ...
     *
     * @return \Houphp\Support\MessageBag
     */
    ...
    {
        if ($extensions) {
            $keys = array_map('\Houphp\Support\Str::snake', array_keys($extensions));
    ...
    {
        if ($replacers) {
            $keys = array_map('\Houphp\Support\Str::snake', array_keys($replacers));
     ...
     *
     * @return \Houphp\Validation\PresenceVerifierInterface
     *
     ...
     *
     * @param  \Houphp\Validation\PresenceVerifierInterface  $presenceVerifier
     * @return void
     */
     ...
     *
     * @return \Houphp\Contracts\Translation\Translator
     */
