...
use Houphp\Contracts\View\Factory;
use Houphp\Support\Traits\Macroable;
use Houphp\Contracts\Support\Htmlable;
...
use Houphp\Contracts\Queue\Factory as QueueContract;
use Houphp\Contracts\Mail\Mailable as MailableContract;
use Houphp\Contracts\Mail\MailQueue as MailQueueContract;
...
class Mailer implements MailerContract, MailQueueContract
{
     ...
     *
     * @var \Houphp\Contracts\Events\Dispatcher|null
     */
    protected $events;
     ...
     *
     * @var \Houphp\Contracts\Queue\Factory
     */
    protected $queue;
     ...
     *
     * @param  \Houphp\Contracts\View\Factory  $views
     * @param  \Swift_Mailer  $swift
     * @param  \Houphp\Contracts\Events\Dispatcher|null  $events
     * @return void
     */
     ...
     *
     * @param  mixed  $users
     * @return \Houphp\Mail\PendingMail
     */
     ...
     *
     * @param  string|array|\Houphp\Contracts\Mail\Mailable  $view
     * @param  array  $data
     ...
     *
     * @param  \Houphp\Mail\Message  $message
     * @param  string  $view
     * @param  string  $plain
     * @param  string  $raw
     * @param  array  $data
     ...
     *
     * @param  \Houphp\Contracts\Mail\Mailable  $view
     ...
     *
     * @return \Houphp\Contracts\View\Factory
     */
