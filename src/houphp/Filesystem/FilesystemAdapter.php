...
use Houphp\Contracts\Filesystem\Cloud as CloudFilesystemContract;
use Houphp\Contracts\Filesystem\Filesystem as FilesystemContract;
use Houphp\Contracts\Filesystem\FileExistsException as ContractFileExistsException;
use Houphp\Contracts\Filesystem\FileNotFoundException as ContractFileNotFoundException;
...
class FilesystemAdapter implements FilesystemContract, CloudFilesystemContract
{
     ...
     * @return string
     *
     * @throws \Houphp\Contracts\Filesystem\FileNotFoundException
     */
     ...
     *
     * @param  string  $path
     * @param  \Houphp\Http\File|\Houphp\Http\UploadedFile  $file
     * @param  array  $options
     * @return string|false
     */
