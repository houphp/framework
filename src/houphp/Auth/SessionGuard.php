...
use Houphp\Support\Facades\Hash;
use Houphp\Support\Traits\Macroable;
use Houphp\Contracts\Session\Session;
use Houphp\Contracts\Auth\UserProvider;
use Houphp\Contracts\Events\Dispatcher;
use Houphp\Contracts\Auth\StatefulGuard;
use Symfony\Component\HttpFoundation\Request;
use Houphp\Contracts\Auth\SupportsBasicAuth;
use Houphp\Contracts\Cookie\QueueingFactory as CookieJar;
...
class SessionGuard implements StatefulGuard, SupportsBasicAuth
{
     ...
     *
     * @var \Houphp\Contracts\Session\Session
     */
    protected $session;

    /**
     * The Houphp cookie creator service.
     *
     * @var \Houphp\Contracts\Cookie\QueueingFactory
     */
    protected $cookie;
     ...
     *
     * @param  string  $name
     * @param  \Houphp\Contracts\Auth\UserProvider  $provider
     * @param  \Houphp\Contracts\Session\Session  $session
     ...
     *
     * @param  \Houphp\Auth\Recaller  $recaller
     * @return mixed
     */
     ...
     *
     * @return \Houphp\Auth\Recaller|null
     */
     ...
     *
     * @param  mixed  $id
     * @return \Houphp\Contracts\Auth\Authenticatable|false
     */
     ...
     *
     * @param  \Houphp\Contracts\Auth\Authenticatable|null  $user
     * @param  array  $credentials
     * @return void
     */
     ...
     *
     * @return \Houphp\Contracts\Auth\Authenticatable
     */
     ...
     *
     * @return \Houphp\Contracts\Cookie\QueueingFactory
     *
     ...
     *
     * @param  \Houphp\Contracts\Cookie\QueueingFactory  $cookie
     * @return void
     */
     ...
     *
     * @return \Houphp\Contracts\Session\Session
     */
