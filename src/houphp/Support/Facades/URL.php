 ...
 * @method static \Houphp\Contracts\Routing\UrlGenerator setRootControllerNamespace(string $rootNamespace)
 ...
 * @method static string hasValidSignature(\Houphp\Http\Request $request, bool $absolute = true)
 * @method static void defaults(array $defaults)
 *
 * @see \Houphp\Routing\UrlGenerator
 */
