...
namespace Houphp\Database\Schema;
...
use Houphp\Database\SQLiteConnection;
use Houphp\Database\Schema\Grammars\Grammar;
...
class Blueprint
{
     ...
     *
     * @var \Houphp\Database\Schema\ColumnDefinition[]
     */
    protected $columns = [];
     ...
     * @param  string|array  $columns
     * @param  string|null  $name
     * @return \Houphp\Support\Fluent|\Houphp\Database\Schema\ForeignKeyDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \Houphp\Database\Schema\ColumnDefinition
     */
