...
class Route
{
     ...
     *  )
     *  如果配置了route:
     *  调用 \houphp\Common\Route::makeUrl('main\\main', 'reg'),  将生成url http://host/reg
     *  调用 \houphp\Common\Route::makeUrl('main\\product', 'show', array("id"=>123, "uid"=>321)),  将生成url http://host/product/123?uid=321
     */
